...
export default function DowntownSummerlin() {
  return (
    <div className={styles.page}>
      <Head>
        <title>Downtown Summerlin Real Estate Guide | Summerlin West</title>
        <meta name="description" content="Explore shopping, dining, entertainment, and real estate market insights for Downtown Summerlin. Get your free market report today!" />
        <meta property="og:title" content="Downtown Summerlin Real Estate Guide" />
        <meta property="og:description" content="Explore shopping, dining, entertainment, and real estate market insights for Downtown Summerlin. Get your free market report today!" />
      </Head>
      ...
      <section style={{marginBottom: '2.5rem'}}>
        ...
        <div style={{display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap'}}>
          <img src="https://placehold.co/320x200?text=Shopping" alt="Downtown Summerlin Shopping" style={{borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
      ...
      <section style={{marginBottom: '2.5rem'}}>
        ...
        <div style={{display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap', flexDirection: 'row-reverse'}}>
          <img src="https://placehold.co/320x200?text=Dining" alt="Downtown Summerlin Dining" style={{borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
          <p style={{flex: 1, minWidth: 220, color: '#0A2540', fontSize: '1.08rem'}}>
      ...
      <section style={{marginBottom: '2.5rem'}}>
        ...
        <div style={{display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap'}}>
          <img src="https://placehold.co/320x200?text=Entertainment" alt="Downtown Summerlin Entertainment" style={{borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
          <p style={{flex: 1, minWidth: 220, color: '#0A2540', fontSize: '1.08rem'}}>
      ...
      <section style={{marginBottom: '2.5rem', background: '#F7F9FC', borderRadius: '8px', padding: '2rem 1rem'}}>
        ...
        <div style={{display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap', flexDirection: 'row-reverse'}}>
          <img src="https://placehold.co/320x200?text=Real+Estate" alt="Downtown Summerlin Real Estate" style={{borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}} />
