...
const communitiesPageAuditData = {
  ...
  metaDescription: 'Explore all Summerlin West communities including The Vistas, Redpoint, Stonebridge & more. Find neighborhood guides, amenities, and expert insights for Summerlin real estate.',
  structuredData: true,
  coreWebVitals: {
    lcp: 2.0, // Good
    cls: 0.06, // Good
  ...
  locationKeywords: ['Summerlin West', 'Las Vegas', 'The Vistas', 'Redpoint', 'Stonebridge', 'The Paseos', 'Reverence', 'Nevada'],
  realEstateElements: [
    'community listings',
    'neighborhood guides',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Community Content Strengths</h3>
          ...
          <div className="mt-6 p-4 bg-purple-50 rounded-lg">
            <h4 className="font-semibold text-purple-900 mb-2">Key Recommendations for Communities Page:</h4>
