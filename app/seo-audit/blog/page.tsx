...
const blogPageAuditData = {
  ...
  metaDescription:
    'Stay updated with the latest Summerlin West real estate market insights, community news, and expert analysis from Dr. Jan Duffy. Get insider knowledge about luxury homes and neighborhoods.',
  structuredData: true,
  coreWebVitals: {
    lcp: 2.2, // Good
    cls: 0.07, // Good
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Blog Page SEO Audit</h1>
          <p className="text-lg text-gray-600">Content strategy and blog structure analysis</p>
        </div>

        <SEOAuditComponent data={blogPageAuditData} onRecommendations={handleRecommendations} />
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="mt-6 p-4 bg-indigo-50 rounded-lg">
            <h4 className="font-semibold text-indigo-900 mb-2">
              Key Recommendations for Blog Page:
            </h4>
