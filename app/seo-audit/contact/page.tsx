    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Contact Page SEO Audit</h1>
          <p className="text-lg text-gray-600">
            Lead capture optimization and contact form analysis
          </p>
        </div>

        <SEOAuditComponent data={contactPageAuditData} onRecommendations={handleRecommendations} />
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-lg">
            <h4 className="font-semibold text-green-900 mb-2">
              Key Recommendations for Contact Page:
            </h4>
