    ...
    <div className={styles.page}>
      ...
      >
        <div style={{ flex: 1, minWidth: 260 }}>
          <h2>Our Office</h2>
          <Image
            src="https://placehold.co/400x220?text=Map+Placeholder"
          ...
          >
            <strong>Address:</strong> 1234 Summerlin Centre Dr, Las Vegas, NV
            89138
          </div>
          <div
            style={{
          ...
          >
            ...
            <a
              href="tel:7025551234"
              style={{ color: "#3A8DDE", textDecoration: "none" }}
            >
              {" "}
              (702) 555-1234
            </a>
          ...
          <div style={{ display: "flex", gap: "1rem", marginTop: "0.5rem" }}>
            <a
              ...
              rel="noopener"
              aria-label="Facebook"
              style={{ color: "#3A8DDE", fontSize: "1.3rem" }}
            >
              Facebook
            </a>
            <a
              ...
              style={{ color: "#16B286", fontSize: "1.3rem" }}
            >
              Instagram
            </a>
            <a
              ...
              rel="noopener"
              aria-label="YouTube"
              style={{ color: "#0A2540", fontSize: "1.3rem" }}
            >
              YouTube
            </a>
          </div>
        ...
        <div style={{ flex: 1, minWidth: 260 }}>
          ...
          <div
            style={{ marginTop: "2rem", color: "#888", fontSize: "0.98rem" }}
          >
