...
const marketInsights = [
  {
    ...
    description:
      'Paradiso continues to see strong buyer demand with properties selling quickly in the current market.',
    trend: 'positive',
  },
  {
    title: 'Price Appreciation',
    description:
      'Home values in Paradiso have increased 8.5% year-over-year, outpacing the broader Summerlin West market.',
    trend: 'positive',
  },
  {
    title: 'Limited Inventory',
    description:
      'With only 3 active listings, inventory remains tight, creating competitive conditions for buyers.',
    trend: 'neutral',
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="bg-gradient-to-r from-blue-900 via-blue-800 to-purple-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Paradiso Market Report</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Dr. Jan Duffy provides expert insights on the current Paradiso market conditions and
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg leading-relaxed">
              "Paradiso continues to be one of the most sought-after subdivisions in Summerlin West.
              The combination of Pulte Homes' quality construction, gated community security, and
              proximity to Red Rock Canyon creates exceptional value for luxury homebuyers. With
              only 3 active listings and an average of 18 days on market, we're seeing a very
              competitive seller's market. The 8.5% year-over-year price appreciation demonstrates
              strong demand and limited supply. For buyers, this means acting quickly when
              properties come to market. For sellers, it's an excellent time to list with proper
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-700 text-center mb-8 max-w-3xl mx-auto">
            Browse the latest homes for sale in Paradiso subdivision. These properties offer luxury
            living with mountain views and gated community access.
          </p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Buy or Sell in Paradiso?</h2>
          <p className="text-xl mb-8 text-blue-100">
            Dr. Jan Duffy specializes in Paradiso subdivision and can provide expert guidance on
