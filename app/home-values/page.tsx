...
export const metadata: Metadata = {
  ...
  description:
    "Discover your Las Vegas home's true value in 2025. See current market prices, recent sales, and get your free home valuation from Dr. Jan Duffy - Top 1% Las Vegas REALTOR®.",
  keywords: [
...
const structuredData = {
  ...
  areaServed: ['Las Vegas', 'Summerlin West', 'Henderson', 'Centennial Hills', 'The Lakes'],
