      ...
      <main>
        ...
        <section className={styles.introSection}>
          <div className={styles.introContainer}>
            <div className={styles.introContent}>
              <h2 className={styles.introTitle}>Build Your Dream Home in Summerlin West</h2>
              <p className={styles.introText}>Discover the ultimate in luxury living with brand-new construction homes in Summerlin West, Las Vegas's most prestigious master-planned community. As your dedicated new construction specialist, Dr. Jan Duffy provides expert guidance through every step of building your dream home with Summerlin's premier national builders.</p>
              <p className={styles.introText}>From energy-efficient designs to cutting-edge smart home technology, these new homes offer the perfect blend of innovation, quality, and the legendary Summerlin lifestyle—all with breathtaking Red Rock Canyon views and world-class amenities at your doorstep.</p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.buildersSection}>
          <div className={styles.buildersContainer}>
            <h2 className={styles.buildersTitle}>Meet Summerlin's Premier Builders</h2>
            <p className={styles.buildersSubtitle}>Summerlin's all-star roster of national homebuilders ensures quality, innovation, and progressive home design while maintaining the community's aesthetic excellence and lasting value.</p>
            <div className={styles.buildersGrid}>
              ...
              {[
                ...
                <div key={builder.name} className={styles.builderCard}>
                  ...
                  <a href={builder.link} className={styles.viewInventoryBtn} target="_blank" rel="noopener noreferrer">View {builder.name} Inventory</a>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className={styles.benefitsSection}>
          <div className={styles.benefitsContainer}>
            <h2 className={styles.benefitsTitle}>Why Choose New Construction in Summerlin West?</h2>
        ...
        <section className={styles.ctaSection}>
          <div className={styles.ctaContainer}>
            <div>
              <h2 className={styles.ctaTitle}>Ready to Build Your Summerlin West Dream Home?</h2>
              <p className={styles.ctaText}>Let Dr. Jan Duffy guide you through the new construction process with her expert knowledge of builders, communities, and market timing.</p>
              <div className={styles.ctaButtons}>
                <a href="https://drjanduffy.realscout.com/homesearch/shared-searches/U2hhcmVhYmxlU2VhcmNoTGluay05NTMy" className={styles.ctaBtn} target="_blank" rel="noopener noreferrer">
