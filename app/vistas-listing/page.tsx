...
export default function VistasListing() {
  ...
  return (
    <div className={styles.page}>
      <Head>
        <title>Vistas Summerlin Home Listings | Summerlin West Real Estate</title>
        <meta name="description" content="Browse Vistas Summerlin home listings. See photos, property details, and connect with a Summerlin real estate expert for private tours and market insights." />
        <meta property="og:title" content="Vistas Summerlin Home Listings | Summerlin West Real Estate" />
        <meta property="og:description" content="Browse Vistas Summerlin home listings. See photos, property details, and connect with a Summerlin real estate expert for private tours and market insights." />
      </Head>
      <section className={styles.hero} style={{marginBottom: '2rem'}}>
        <h1>Vistas Summerlin Home Listings</h1>
        <p className={styles.subtitle}>Find your dream home in The Vistas, Summerlin West</p>
      </section>
        ...
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem', maxWidth: '900px', margin: '0 auto'}}>
          {[1,2,3].map((i) => (
            <div key={i} style={{borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', background: '#fff'}}>
              <Image src={`https://placehold.co/400x220?text=Vistas+Listing+${i}`} alt={`Vistas Summerlin home listing ${i}`} width={400} height={220} style={{width: '100%', height: 'auto', display: 'block'}} />
