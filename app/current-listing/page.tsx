  ...
  return (
    <div className={styles.page}>
      <Head>
        ...
        <meta name="description" content="Tour this stunning home for sale in The Vistas, Summerlin. View photos, property details, market analysis, and schedule a private showing with a Summerlin expert." />
        <meta property="og:title" content="The Vistas Summerlin Home for Sale | Summerlin West Real Estate" />
        <meta property="og:description" content="Tour this stunning home for sale in The Vistas, Summerlin. View photos, property details, market analysis, and schedule a private showing with a Summerlin expert." />
        ...
        <div style={{
          ...
          {[1,2,3,4,5,6].map((i) => (
            <div key={i} style={{borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)'}}>
              <Image src={`https://placehold.co/400x300?text=Photo+${i}`} alt={`The Vistas Summerlin home photo ${i}`} width={400} height={300} style={{width: '100%', height: 'auto', display: 'block'}} />
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{marginBottom: '2.5rem', background: '#F7F9FC', borderRadius: '8px', padding: '2rem 1rem'}}>
        ...
        <ul style={{color: '#3A8DDE', fontWeight: 600, fontSize: '1.08rem', marginLeft: '1rem', listStyle: 'disc inside'}}>
          ...
          <li><Link href="/contact">Contact for a private showing</Link></li>
        </ul>
      </section>
