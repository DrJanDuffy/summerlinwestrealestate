...
export const metadata: Metadata = {
  ...
  description:
    'Find homes for sale near Palo Verde High School in Summerlin West. Top-rated high school serving The Vistas communities. Expert guidance from Dr. Jan Duffy.',
  keywords: [
    'Palo Verde High School',
    'homes near Palo Verde High',
    'Summerlin West high school',
    'The Vistas school district',
    'Las Vegas high schools',
    'homes zoned to Palo Verde High',
  ...
  openGraph: {
    title: 'Homes for Sale Near Palo Verde High School | Summerlin West Real Estate',
    description:
      'Find homes for sale near Palo Verde High School in Summerlin West. Top-rated high school serving The Vistas communities.',
    url: 'https://www.summerlinwestrealestate.com/schools/palo-verde-high',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Palo Verde High School - Summerlin West',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const subdivisionsZonedToPaloVerde = [
  { name: 'Cara Vella', distance: '0.0 mi', slug: 'cara-vella' },
  { name: 'Miraleste', distance: '0.1 mi', slug: 'miraleste' },
  { name: 'Sage Hills', distance: '0.2 mi', slug: 'sage-hills' },
  { name: 'Santalina', distance: '0.3 mi', slug: 'santalina' },
  { name: 'Solano', distance: '0.4 mi', slug: 'solano' },
  { name: 'Sonesta', distance: '0.5 mi', slug: 'sonesta' },
  { name: 'Canterra', distance: '0.2 mi', slug: 'canterra' },
  { name: 'Capri', distance: '0.1 mi', slug: 'capri' },
  { name: 'Talega', distance: '0.3 mi', slug: 'talega' },
  { name: 'Vista Verde', distance: '0.4 mi', slug: 'vista-verde' },
  { name: 'Summerfield', distance: '0.5 mi', slug: 'summerfield' },
  { name: 'Somerset', distance: '0.6 mi', slug: 'somerset' },
  { name: 'Encanto', distance: '0.7 mi', slug: 'encanto' },
  { name: 'Portofino', distance: '0.8 mi', slug: 'portofino' },
  { name: 'Bella Vista', distance: '0.9 mi', slug: 'bella-vista' },
  { name: 'Hillstone', distance: '1.0 mi', slug: 'hillstone' },
  { name: 'Ashton Park', distance: '1.1 mi', slug: 'ashton-park' },
  { name: 'Kingwood', distance: '1.2 mi', slug: 'kingwood' },
  { name: 'Monterossa', distance: '1.3 mi', slug: 'monterossa' },
  { name: 'Barrington', distance: '1.4 mi', slug: 'barrington' },
  { name: 'Sonesta', distance: '1.5 mi', slug: 'sonesta' },
  { name: 'San Marcos', distance: '1.6 mi', slug: 'san-marcos' },
  { name: 'Casa Rosa', distance: '1.7 mi', slug: 'casa-rosa' },
  { name: 'Talaverde', distance: '1.8 mi', slug: 'talaverde' },
  { name: 'Estancia', distance: '1.9 mi', slug: 'estancia' },
  { name: 'Palmilla', distance: '2.0 mi', slug: 'palmilla' },
  { name: 'Paradiso', distance: '2.1 mi', slug: 'paradiso' },
];

export default function PaloVerdeHighPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Top-rated high school serving The Vistas communities in Summerlin West
            </p>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 max-w-2xl mx-auto">
              <h2 className="text-2xl font-semibold mb-4">Palo Verde High School</h2>
              <p className="text-lg mb-2">333 S Pavilion Center Dr, Las Vegas, NV 89144</p>
              <p className="text-lg mb-2">Phone: (702) 799-4440</p>
              <p className="text-lg">Grades: 9-12</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Top-rated academic programs and AP courses</span>
                </div>
                <div className="flex items-center">
                  <span className="text-green-600 text-xl mr-3">✓</span>
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">~2,800 students</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-700">School Type:</span>
                  <span className="font-semibold">Public High School</span>
                </div>
                <div className="flex justify-between">
      ...
      {/* Subdivisions Zoned to Palo Verde High */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">
            Subdivisions Zoned to Palo Verde High School
          </h2>
      ...
      {/* Properties Near Palo Verde High */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">
            Homes for Sale Near Palo Verde High School
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Top-rated high school serving The Vistas communities in Summerlin West',
            address: {
              '@type': 'PostalAddress',
