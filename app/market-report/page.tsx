...
export default function MarketReport() {
  return (
    <div className={styles.page}>
      <Head>
        <title>
          Summerlin Market Report | Current Trends & Analysis | Summerlin West
          Real Estate
        </title>
        <meta
          name="description"
          content="Get the latest Summerlin real estate market report with current trends, pricing data, and expert analysis. Download your free market report today."
        />
        <meta
          property="og:title"
          content="Summerlin Market Report | Current Trends & Analysis | Summerlin West Real Estate"
        />
        <meta
      ...
      <div className={styles.mainContent}>
        <section className={styles.hero}>
          ...
          <p className={styles.subtitle}>
            Your comprehensive guide to the current Summerlin real estate market
          </p>
        </section>
        ...
        <section className={styles.sectionCard}>
          ...
          <div className={styles.marketAnalysis}>
            <div className={styles.analysisSection}>
              ...
              <p>
                The Summerlin real estate market continues to show strong
                fundamentals with low inventory and high demand driving
                competitive pricing. New construction is helping to meet demand,
                but resale homes remain highly sought after.
              </p>
            </div>
            <div className={styles.analysisSection}>
              <strong>Price Trends</strong>
              <p>
                Median home prices have increased 8.5% year-over-year, with
                luxury segments ($1M+) showing the strongest appreciation.
                Entry-level homes are experiencing the most competition with
            ...
            <div className={styles.analysisSection}>
              ...
              <p>
                Active listings are down 15% compared to last year, creating a
                seller's market. New construction communities like Redpoint and
                Stonebridge are helping to increase supply, but demand continues
        ...
        <section className={styles.sectionCard}>
          <h2 className={styles.centerTitle}>
            Download Your Complete Market Report
          </h2>
          <LeadCaptureForm
            variant="inline"
              ...
              <div key={index} className={styles.featuredListingCard}>
                <div className={styles.listingContent}>
                  ...
                  <p className={styles.listingDetails}>
                    Median Price • {neighborhood.change} YoY
                  </p>
        ...
        <section className={styles.sectionCard}>
          <h2 className={styles.centerTitle}>
            Stay Updated with Monthly Reports
          </h2>
          <LeadCaptureForm
            variant="inline"
        ...
        <section className={styles.sectionCard}>
          ...
          <ul className={styles.resourceLinks}>
            <li>
              <Link href="/market-reports">View All Market Reports</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/contact">Get a Custom Market Analysis</Link>
            </li>
          </ul>
        </section>
