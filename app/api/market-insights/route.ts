  ...
  try {
    ...
    const fallbackArticles: MarketArticle[] = [
      ...
      },
      {
        ...
        excerpt: "Right now, about 50% of homes on the market are selling for less than their asking price. In this return to normal, your pricing strategy is more important than ever.",
        ...
        content: "If your selling strategy still assumes you'll get multiple offers over asking, it's officially time for a reset. That frenzied seller's market is behind us."
      }
    ];
