...
const fixes = [
  // Remove unused variable assignments
  {
    ...
    fixes: [
      {
        search: 'const { source: _source } = useLeadCaptureModal();',
        replace: '// const { source: _source } = useLeadCaptureModal();',
      },
    ],
  },
  ...
  // Remove unused imports and variables in blog page
  {
    ...
    fixes: [
      ...
      {
        search: 'const _LOCAL_MARKET_INSIGHTS = [',
        replace: '// const _LOCAL_MARKET_INSIGHTS = [',
      },
  ...
  // Remove unused parameters in RealScout components
  {
    ...
    fixes: [
      ...
      {
        search: "communities = ['Summerlin West'],",
        replace: "communities: _communities = ['Summerlin West'],",
      },
      {
        search: "agentId = 'QWdlbnQtMjI1MDUw',",
        replace: "agentId: _agentId = 'QWdlbnQtMjI1MDUw',",
      },
    ],
  },

  {
    ...
    fixes: [
      {
        search: "title = 'Get Your Free Home Valuation',",
        replace: "title: _title = 'Get Your Free Home Valuation',",
      },
      {
        search: "subtitle = 'Discover your home's current market value',",
        replace: "subtitle: _subtitle = 'Discover your home's current market value',",
      },
      { search: "variant = 'lead-capture',", replace: "variant: _variant = 'lead-capture'," },
      { search: "source = 'Homepage',", replace: "source: _source = 'Homepage'," },
      {
        search: "community = 'Summerlin West',",
        replace: "community: _community = 'Summerlin West',",
      },
      {
        search: "propertyType = 'Single Family',",
        replace: "propertyType: _propertyType = 'Single Family',",
      },
      ...
      {
        search: 'showMarketReport = true,',
        replace: 'showMarketReport: _showMarketReport = true,',
      },
      { search: 'showValuation = true,', replace: 'showValuation: _showValuation = true,' },
      {
        search: 'showConsultation = true,',
        replace: 'showConsultation: _showConsultation = true,',
      },
    ],
  },
  ...
  // Fix unused parameters in other RealScout components
  {
    ...
    fixes: [
      ...
      {
        search: "updateFrequency = 'monthly',",
        replace: "updateFrequency: _updateFrequency = 'monthly',",
      },
    ],
  },

  {
    ...
    fixes: [
      {
        search: "title = 'Home Value Estimator',",
        replace: "title: _title = 'Home Value Estimator',",
      },
      {
        search: "subtitle = 'Get an instant estimate of your home's value',",
        replace: "subtitle: _subtitle = 'Get an instant estimate of your home's value',",
      },
      ...
      {
        search: 'showMarketAnalysis = true,',
        replace: 'showMarketAnalysis: _showMarketAnalysis = true,',
      },
      {
        search: 'showInvestmentMetrics = true,',
        replace: 'showInvestmentMetrics: _showInvestmentMetrics = true,',
      },
      {
        search: "agentId = 'QWdlbnQtMjI1MDUw',",
        replace: "agentId: _agentId = 'QWdlbnQtMjI1MDUw',",
  ...
  // Fix unused variables in other components
  {
    ...
    fixes: [
      {
        search: 'const [scriptError, setScriptError] = useState<string | null>(null);',
        replace: 'const [scriptError, _setScriptError] = useState<string | null>(null);',
      },
    ],
  },
