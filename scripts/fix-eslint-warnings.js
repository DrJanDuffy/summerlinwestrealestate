...
const fixes = [
  // API routes - prefix unused parameters with underscore
  {
    ...
    fixes: [
      { search: 'export async function GET(req: NextRequest)', replace: 'export async function GET(_req: NextRequest)' }
    ]
  },
  {
  ...
  // Component unused variables - prefix with underscore
  {
    ...
    fixes: [
      { search: 'const borderColor =', replace: 'const _borderColor =' }
    ]
  },
  {
    file: 'components/ui/BlogLayout.tsx',
    fixes: [
      { search: 'const relatedPosts =', replace: 'const _relatedPosts =' }
    ]
  },
  {
  ...
  },
  {
    ...
    fixes: [
      { search: 'onChange={(e) =>', replace: 'onChange={(_e) =>' }
    ]
  },
  {
    file: 'components/ui/SectionCard.tsx',
    fixes: [
      { search: 'function SectionCard(props: SectionCardProps)', replace: 'function SectionCard(_props: SectionCardProps)' }
    ]
  },
  {
    file: 'components/ui/TestimonialsSection.tsx',
    fixes: [
      { search: 'const _TESTIMONIALS =', replace: '// const _TESTIMONIALS =' }
    ]
  },
