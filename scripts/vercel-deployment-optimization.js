  ...
  security: {
    headers: {
      ...
      'Content-Security-Policy':
        "default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://api.realscout.com https://www.google-analytics.com;",
    },
    cors: {
...
function main() {
  ...
  console.log(
    `Real Estate Features: ${report.realEstate.realScoutIntegrated ? 'RealScout integrated' : 'RealScout not configured'}`
  );
