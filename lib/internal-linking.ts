...
export function getRelatedLinks(keywords: string[], limit: number = 5): InternalLink[] {
  ...
  return allInternalLinks
    .filter((link) => link.keywords.some((keyword) => keywordSet.has(keyword.toLowerCase())))
    .slice(0, limit);
}
    ...
    relatedLinks: [
      {
        href: '/service-area/the-vistas',
        text: 'The Vistas Community',
        description: 'Explore all 26 subdivisions',
        category: 'secondary',
        keywords: ['the vistas'],
      },
      {
        href: '/service-area/stonebridge',
        text: 'Stonebridge Community',
        description: 'Gated luxury with amenities',
        category: 'secondary',
      ...
      },
      {
        href: '/service-area/paradiso',
        text: 'Paradiso Subdivision',
        description: 'Custom luxury homes',
        category: 'secondary',
        keywords: ['paradiso'],
      },
    ],
    ...
    relatedLinks: [
      {
        href: '/home-values',
        text: 'Home Values',
        description: 'Get accurate valuations',
        category: 'secondary',
        keywords: ['home values'],
      },
      {
        href: '/current-listing',
        text: 'Current Listings',
        description: 'Featured properties for sale',
        category: 'secondary',
        keywords: ['current listings'],
      },
      {
        href: '/market-reports',
        text: 'Market Reports',
    ...
    relatedLinks: [
      {
        href: '/about',
        text: 'About Dr. Jan Duffy',
        description: 'Learn about her expertise',
        category: 'primary',
        keywords: ['about'],
      },
      {
        href: '/testimonials',
        text: 'Client Testimonials',
        description: 'Read client reviews',
        category: 'contextual',
        keywords: ['testimonials'],
      },
      {
        href: '/contact',
        text: 'Contact Dr. Jan Duffy',
