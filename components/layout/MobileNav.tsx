        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-4 mt-8 mb-8">
              {navLinks.map(link => (
                <Link
                  ...
                  href={link.href}
                  onClick={onClose}
                  className="text-lg font-medium text-[#0A2540] py-2 px-3 rounded hover:bg-[#F7F9FC] active:bg-[#3A8DDE] transition-colors"
            ...
            <div className="flex flex-col gap-3 mb-8">
              <a href="tel:7025551234" className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#16B286] text-white rounded font-semibold text-base shadow hover:bg-[#13996e] transition-colors" style={{ touchAction: 'manipulation' }}>
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.12.37 2.33.57 3.58.57a1 1 0 011 1V20a1 1 0 01-1 1C10.07 21 3 13.93 3 5a1 1 0 011-1h3.5a1 1 0 011 1c0 1.25.2 2.46.57 3.58a1 1 0 01-.24 1.01l-2.2 2.2z"/></svg>
                Call
              </a>
              <a href="mailto:info@summerlinwestrealestate.com" className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#3A8DDE] text-white rounded font-semibold text-base shadow hover:bg-[#2563eb] transition-colors" style={{ touchAction: 'manipulation' }}>
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2zm0 2v.01L12 13 4 6.01V6h16zM4 18V8.83l7.29 6.46a1 1 0 001.42 0L20 8.83V18H4z"/></svg>
                Email
              </a>
            </div>
            {/* Social media links */}
            <div className="flex gap-4 justify-center mt-auto">
              <a href="https://facebook.com" target="_blank" rel="noopener" aria-label="Facebook" className="hover:text-[#3A8DDE]" style={{ fontSize: 24 }}>
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener" aria-label="Instagram" className="hover:text-[#16B286]" style={{ fontSize: 24 }}>
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener" aria-label="YouTube" className="hover:text-[#0A2540]" style={{ fontSize: 24 }}>
