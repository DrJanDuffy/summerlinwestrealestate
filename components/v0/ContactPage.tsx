          ...
          <section className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <svg
                  className="w-8 h-8 text-blue-600 mr-4 mt-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Summerlin West, Las Vegas, Nevada</p>
                  <p className="text-gray-600">The Vistas, San Marcos, Casa Rosa & More</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 mt-8">
              ...
              <p className="text-gray-600 mb-4">Schedule a free consultation with Dr. Jan Duffy</p>
              <a
                href="#"
