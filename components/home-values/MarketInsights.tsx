...
const insights: InsightData[] = [
  {
    ...
    content: 'Home values increased 5.5% this year - but online estimates miss the mark by 15-20%. Your corner lot, upgraded kitchen, or pool could add $50K+ to your value. Recent example: 425 Desert Rose listed at $520K, sold for $547K in 12 days with 6 offers.',
    bottomLine: "Don't rely on Zillow's \"Zestimate\" - your home's worth more than you think."
  },
  {
    title: '🎯 For Buyers: Strategy Beats Speed',
    content: 'Inventory up 31% means more choices, but 67% of homes still sell in 30 days. Smart buyers win with proper pre-approval, local market knowledge, and strategic offer timing. This week\'s winner: $475K offer on $485K list price with inspection waiver.',
  ...
  return (
    <section ref={sectionRef} className={`${styles.marketInsights} ${className || ''}`}>
      <div className={styles.container}>
        ...
        <p className={styles.sectionSubtitle}>Expert insights from 20+ years in Las Vegas luxury real estate</p>
