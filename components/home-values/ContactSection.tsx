      ...
      <div className={styles.container}>
        <div className={styles.contactContent}>
          ...
          <p className={`${styles.contactSubtitle} ${isVisible ? styles.fadeInUp : ''}`}>
            I'll pull fresh comparables tonight and show you exactly what your home's worth in
            today's market
          </p>
          ...
          <div className={`${styles.agentInfo} ${isVisible ? styles.fadeInUp : ''}`}>
            ...
            <p className={styles.agentTitle}>Las Vegas Real Estate Expert 🎰</p>
            <p className={styles.agentCredentials}>Top 1% REALTOR® | 20+ Years Proven Results</p>
            <p className={styles.licenseNumber}>License #S.0185709</p>
          </div>
