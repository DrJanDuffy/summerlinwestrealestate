  ...
  return (
    <section ref={sectionRef} className={`${styles.neighborhoodSpotlight} ${className || ''}`}>
      <div className={styles.container}>
        ...
        <p className={styles.sectionSubtitle}>Recent sales in Las Vegas's most sought-after areas</p>
          ...
          {neighborhoods.map((neighborhood, neighborhoodIndex) => (
            ...
            >
              ...
              <p className={styles.priceInfo}>
                <strong>Median Price:</strong> {neighborhood.medianPrice} ({neighborhood.priceChange})
              </p>
