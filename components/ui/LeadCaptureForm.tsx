    ...
    >
      ...
      {submitStatus === 'success' ? (
        ...
        >
          ...
          <h3>Thank You!</h3>
          <p>Your request has been submitted successfully. We'll be in touch within 24 hours.</p>
          {variant === 'inline' && (
            <button 
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className={styles['form-grid']}>
            ...
            <div className={styles['form-group']}>
              ...
              />
              {errors.propertyInterest && <span className={styles['error-message']}>{errors.propertyInterest.message}</span>}
            </div>
            ...
            <div className={`${styles['form-group']} ${styles['full-width']}`}> 
              ...
              />
              {errors.privacyConsent && <span className={styles['error-message']}>{errors.privacyConsent.message}</span>}
            </div>
          </div>
          ...
          <div className={styles['form-footer']}>
            <p className={styles['privacy-notice']}>
              <small>
                By submitting this form, you agree to receive communications from Summerlin West Real Estate. 
