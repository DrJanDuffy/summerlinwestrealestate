...
interface RealScoutExactPatternProps {
...
export default function RealScoutExactPattern({
  ...
  if (hasError) {
    return (
      <motion.div
        ...
        className={`realscout-exact-pattern-container ${className}`}
      >
  ...
  return (
    <motion.div
      ...
      className={`realscout-exact-pattern-container ${className}`}
    >
      {/* RealScout Office Listings with exact pattern you provided */}
      <style jsx>{`
