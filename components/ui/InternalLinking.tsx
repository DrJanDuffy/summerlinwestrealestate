...
import { InternalLink, getContextualLinksForPage, featuredSnippetContent } from '../../lib/internal-linking';
...
export default function InternalLinking({ 
  ...
  const featuredContent = showFeaturedSnippets && currentPage 
      ...
      {featuredContent && (
        <div className="featured-snippet-section mb-8 p-6 bg-blue-50 rounded-lg border-l-4 border-blue-500">
          <h3 className="text-lg font-semibold text-gray-900 mb-3">
            {featuredContent.question}
          </h3>
          <p className="text-gray-700 mb-4 leading-relaxed">
            {featuredContent.answer}
          </p>
        ...
        <div className="related-resources">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {relatedLinks.map((link) => (
              <div key={link.href} className="bg-white p-4 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                <Link 
                  href={link.href}
