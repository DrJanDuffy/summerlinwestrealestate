          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="mb-2">
                ...
                {stat.trend && (
                  <div className={`inline-flex items-center ml-3 px-2 py-1 rounded-full text-sm font-medium ${getTrendColor(stat.trend.direction)}`}>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              These market insights show why Summerlin West continues to be one of Las Vegas's most desirable communities. 
              Let Dr. Jan Duffy help you navigate this competitive market.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button type="button" className="px-8 py-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-full hover:bg-gray-50 transition-all duration-300">
